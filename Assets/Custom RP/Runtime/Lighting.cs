...
public class Lighting
{
    ...
    void SetupDirectionalLight(int index, int visibleIndex, in VisibleLight visibleLight)
    {
    ...
    void SetupPointLight (int index, int visibleIndex, in VisibleLight visibleLight) 
    {
